...
<div class="pub-row">
  ...
  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
    ...
    <div class="links">
      ...
      {% endif %}
      {% if link.bibtex %}
      <label for="{{ link.bibtex }}"><a class="btn btn-sm z-depth-0"><svg src="assets/img/BibTeX_logo.svg" alt="BibTeX logo"></a></label>
      <input type="checkbox" name="{{ link.bibtex }}" id="{{ link.bibtex }}" data-toggle="toggle">
      {% endif %}
      {% if link.notes %} 
