...
This repository contains the source code of my [personal website](https://EirikTengesdal.github.io/). I built it based on [https://github.com/yaoyao-liu/minimal-light](https://github.com/yaoyao-liu/minimal-light), see below.
